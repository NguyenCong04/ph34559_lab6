package com.example.congntph34559_lab6.adapter;
...
import com.example.congntph34559_lab6.databinding.ItemFruitBinding;
...
public class FruitAdapter extends RecyclerView.Adapter<FruitAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FruitAdapter.ViewHolder holder, int position) {
        ...
        holder.binding.tvPriceQuantity.setText(fruit.getPrice()+"");
        holder.binding.tvQuantity.setText(fruit.getQuantity()+"");
        holder.binding.tvDes.setText(fruit.getDescription());
        holder.binding.tvDistributor.setText(fruit.getDistributor().getName());
